...
export type PeerSwapChannelType = {
  ...
  localPercentage: Scalars['String']['output'];
...
export type PeerSwapPeerType = {
  ...
  paidFee: Scalars['String']['output'];
  supportedAssets: Array<Scalars['String']['output']>;
  swapsAllowed: Scalars['Boolean']['output'];
};

export type PeerSwapStatsType = {
  __typename?: 'PeerSwapStatsType';
  satsIn: Scalars['String']['output'];
  satsOut: Scalars['String']['output'];
  swapsIn: Scalars['String']['output'];
  swapsOut: Scalars['String']['output'];
};
...
export type PeerSwapSwapType = {
  ...
  cancelMessage: Scalars['String']['output'];
  channelId: Scalars['String']['output'];
  claimTxId: Scalars['String']['output'];
  createdAt: Scalars['String']['output'];
  id: Scalars['String']['output'];
  initiatorNodeId: Scalars['String']['output'];
  lndChanId: Scalars['String']['output'];
  openingTxId: Scalars['String']['output'];
  peerNodeId: Scalars['String']['output'];
...
export type ServerAccount = {
  ...
  peerSwapEnabled: Scalars['Boolean']['output'];
